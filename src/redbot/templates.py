...
TEMPLATES: tuple[TaskTemplate, ...] = (
    TaskTemplate(
        id="research-brief",
        name="深度研究简报",
        description="把一个主题整理成可执行的研究简报，适合资料研究、竞品和趋势分析。",
        deliverable=(
            "输出 Markdown 简报，包含: 1. 一句话结论; 2. 背景判断; 3. 三个可执行角度; "
            "4. 风险与验证清单; 5. 下一步行动。"
        ),
        system_prompt=(
            "你是 Redbot 的研究助理，擅长把模糊主题变成适合个人和团队执行的研究简报。"
        ),
    ),
    TaskTemplate(
        id="short-video-script",
        name="短沟通脚本",
        description="生成短沟通脚本，强调开头钩子、结构清晰和可执行表达。",
        deliverable=(
            "输出 60-90 秒短沟通脚本，包含: 开头钩子、分段结构、讲解文案、关键展示点、"
            "自然的模型/工具说明、结尾行动建议。"
        ),
        system_prompt=(
            "你是 Redbot 的沟通脚本助理，擅长把技术项目讲成清楚、可执行、容易理解的内容。"
        ),
    ),
    TaskTemplate(
        id="content-table",
        name="内容整理表格",
        description="把零散资料整理成表格，适合资料抓取、竞品收集和项目评估。",
        deliverable=(
            "输出 Markdown 表格，列包含: 项目/资料、核心价值、适合人群、执行角度、扩展空间、优先级。"
        ),
    ...
    TaskTemplate(
        ...
        system_prompt="你是 Redbot 的开源产品助理，擅长把项目整理成开发者容易理解和使用的 GitHub 仓库。",
    ),
)
